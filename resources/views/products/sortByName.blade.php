                ...
                <div class="mt-4">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text mb-2 italic text-center">Click one to start</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            {{-- {{ dd($mostCommented) }} --}}
                            @foreach ($sortBy as $sort)
                                <li class="list-group-item"> <a href="{{ route('product.sortByName') }}">{{ $sort }}
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                ...
                <div class="mt-4">
                    ...
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text mb-2 italic text-center">Vendors with the most product on the site</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            {{-- {{ dd($mostCommented) }} --}}
